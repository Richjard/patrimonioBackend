...
<body> 
    ...
    <br><br>
    <p align="left"><strong>BOLETA DE NOTAS</strong></p>
    ...
    <table border="1" style="font-family: Calibri Light">
        <thead>
            ...
            <tr style="font-size: 10px; ">
                ...
                <td width="100px">&nbsp;{{ date('d-m-Y H:i:s') }}&nbsp;</td>
            </tr>
        </thead>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr style="font-size: 10px; text-align: center;">
                ...
                <td>{{ $detalle->nMatricDetNotaCurso }}</td>
                <td>{{ $detalle->iMatricDetCredCurso * $detalle->nMatricDetNotaCurso }}</td>
                <td>{{ $detalle->iMatricDetAsistEst }}%</td>
                <td>{{ $detalle->tipo_curso }}</td>
                <td></td>
            </tr>
        ...
        <tr>
            <td>
                <table border="1" class="tablita">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ count($detalles) }}</td>
                            <td>{{ $cursosAprobados }}</td>
                        </tr>
                    </tbody>
                </table>
            </td>
            ...
            <td>
                <table border="1" class="tablita">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ $detalles[0]->nMatricPromPond }}</td>
                        </tr>
                    </tbody>
                </table>
            </td>
