...
&nbsp;</strong></div>
        ...
        <br>        <p align="justify" style="line-height:20px; font-size: 14px" >
           Don(ña) {{$cons->cNombreEstudiante}}, con código de matricula N° {{$cons->cEstudCodUniv}}, estudiante de la Carrera Profesional de {{$cons->cCarreraDsc}} sede {{$cons->cFilDescripcion}}, esta cursando el {{$cons->cMatricCiclo}} CICLO en el semestre Academico {{$div}} - {{$mod}}.
        </p>
