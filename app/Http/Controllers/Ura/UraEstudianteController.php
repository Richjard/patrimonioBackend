...
class UraEstudianteController extends Controller
{
    ...
    {
		$estudiantes = \DB::select('exec [ura].[Sp_GRAL_PROC_observados]');
     ...
     * Mod: DASA - Procesar
     */
    public function obtenerEstudiantesPPA($carreraId)
    {
		$estudiantes = \DB::select('exec [ura].[Sp_GRAL_PROC_promedioPonderadoAcumulado]?', array( $carreraId));
